...
class ThermalModel(m5.internal.param_ClockedObject.ClockedObject):
    ...
    __repr__ = _swig_repr
    def addCapacitor(self, *args): return _param_ThermalModel.ThermalModel_addCapacitor(self, *args)
    def addResistor(self, *args): return _param_ThermalModel.ThermalModel_addResistor(self, *args)
    def addReference(self, *args): return _param_ThermalModel.ThermalModel_addReference(self, *args)
    def addDomain(self, *args): return _param_ThermalModel.ThermalModel_addDomain(self, *args)
    def addNode(self, *args): return _param_ThermalModel.ThermalModel_addNode(self, *args)
    def doStep(self): return _param_ThermalModel.ThermalModel_doStep(self)
...
class ThermalModelParams(m5.internal.param_ClockedObject.ClockedObjectParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def create(self): return _param_ThermalModel.ThermalModelParams_create(self)
